...
<!-- End of Title -->
<!-- Content capital -->
<div class="content__capital">
  <!-- content -->
  <div class="content">
    <h2 class="title">Phnom Penh</h2>
  ...
  <!-- end of content -->
  <h2 class="title-small">Top Sights in Phnom Penh...</h2>
  <div class="top-sight">
    <!-- Top sight content -->
    <div class="top-sight-content">
      ...
      <a href="#capital" class="btn">See More <i class="fas fa-chevron-right"></i></a>
    </div>
    ...
    <div class="top-sight-content">
      ...
      <h2>Preah Vihear Preah Keo Morakot.</h2>
      <div class="rate">
    ...
    <div class="top-sight-content">
      ...
      <h2>Tuol Sleng Genocide Museum</h2>
      <div class="rate">
    ...
    <div class="top-sight-content">
      ...
      <h2>National Museum of Cambodia</h2>
      <div class="rate">
        <div class="rate-number">4.1</div>
        <div class="star">
          <i class="fas fa-star" style="color: #fbbc04;"></i>
    ...
    <div class="top-sight-content">
      ...
      <h2>Choeung Ek Genocidal Center</h2>
      <div class="rate">
        <div class="rate-number">4.6</div>
        <div class="star">
          <i class="fas fa-star" style="color: #fbbc04;"></i>
